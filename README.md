...
The user can choose verification range by modifing first virable and second virable of the function "verify".Then the range will be bewteen these two numbers.
